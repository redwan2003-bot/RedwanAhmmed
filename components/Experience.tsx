...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-[80px] md:py-[160px] px-6 bg-transparent relative z-20 overflow-hidden">
              ...
              <motion.div key={idx} variants={itemVariants} className="relative pl-10 md:pl-28 group">
                ...
                <div className="p-6 md:p-10 rounded-[2rem] bg-white/[0.01] border border-white/[0.05] hover:bg-white/[0.03] hover:border-white/10 transition-all duration-500 backdrop-blur-md relative overflow-hidden cursor-pointer">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-2 text-white/50 bg-white/5 px-4 py-2.5 rounded-full w-fit border border-white/5 flex-shrink-0">
                      <Calendar size={14} />
                      <span className="text-sm font-semibold tracking-wide uppercase whitespace-nowrap">{job.dates}</span>
                    </div>
                  </div>
