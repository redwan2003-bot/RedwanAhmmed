...
export default function About() {
  ...
  return (
    <section id="about" className="py-[80px] md:py-[120px] px-6 bg-transparent relative z-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-32 items-center">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2">
          <RevealOnScroll>
            <h2 className="font-syne text-[clamp(36px,8vw,80px)] font-normal text-white leading-[1.2] tracking-[-0.03em] mb-8 md:mb-12">
          ...
          <RevealOnScroll delay={0.2}>
            <div className="space-y-6 text-[#888] font-inter text-[16px] md:text-[18px] leading-relaxed mb-16 max-w-[600px]">
              <p>
