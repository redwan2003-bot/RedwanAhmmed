...
export const TestimonialShowcase: React.FC<TestimonialShowcaseProps> = ({
  ...
  const [activeIndex, setActiveIndex] = useState(() => {
    const index = testimonials.findIndex(t => t.id === defaultTestimonialId);
  ...
  return (
    <div className={cn('w-full select-none max-w-4xl mx-auto space-y-8', className)}>
      ...
      <div
        ...
        className="group relative overflow-hidden rounded-2xl border shadow-xs shadow-white/50 border-border/20 bg-background/80 backdrop-blur-sm transition-all duration-700 hover:border-accent/60 cursor-pointer"
      >
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(232, 255, 0, 0.15), transparent 40%)`,
          }}
        />
